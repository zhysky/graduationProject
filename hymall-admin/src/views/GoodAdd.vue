<template>
  <div>
    <h1>添加商品</h1>
    <el-form label-width="120px" style="margin-top:1rem" @submit.native.prevent="save">
	...
	export default {
		...
		computed: {
			...
			goodForm(){
				...
				goodInfo.sales=Number(this.goodInfo.sales) ;
				goodInfo.inventory=Number(this.goodInfo.inventory);
				good.price=Number(this.good.price);
				return {
					good:{ 
						...good, 
						goodInfo
